// Central place for all the couple/event details.
// Edit these values as real information is confirmed — every page pulls from here.
...
export const wedding = {
  ...
  timeDisplay: "1:00 PM",
  rsvpBy: "September 30, 2026",
  venue: {
    name: "Shrine of St. Pedro Calungsod",
    lines: [
